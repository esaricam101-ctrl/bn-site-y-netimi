...
import { SitePersoneliServisi, type PersonelSatiri } from './site-personeli.service';
import {
  PersonelAyrilDto, PersonelDuzeltDto, PersonelEkleDto, PersonelSilDto,
 ...
 *
 * ⚠️  `/daire-gorevlileri` ile karıştırılmamalıdır: orada işveren malik ya da
 *     kiracıdır (bakıcı, ev yardımcısı, şoför) ve SGK/vardiya/zimmet yoktur.
 *
 ...
 */
@ApiTags('Site Personeli')
@ApiBearerAuth()
@Controller('site-personeli')
export class SitePersoneliController {
  constructor(private readonly servis: SitePersoneliServisi) {}
