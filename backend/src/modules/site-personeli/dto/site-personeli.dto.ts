...
import {
  IsArray, IsDateString, IsIn, IsInt, IsOptional, IsString, IsUUID, Length,
  Matches, Min, MinLength, ValidateNested,
} from 'class-validator';
import { Type } from 'class-transformer';
import { PlakaGirdisiDto } from '../../../common/kayit/kisi-girdisi.dto';
...
export class PersonelEkleDto {
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Personelin araçları. YÖNETİME kayıtlanır, bir bağımsız bölüme DEĞİL: ' +
      'personel aracını bir daireye yazmak o dairenin otopark hakkını ' +
      'tüketmiş gösterir ve kullanım bazlı dağıtımda ona fazla pay çıkarır.',
  })
 ...
 */
export class PersonelDuzeltDto {
