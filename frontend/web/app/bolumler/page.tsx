...
export default function BolumlerSayfasi() {
  ...
  const kolonlar: readonly Kolon<Bolum>[] = [
    ...
    { anahtar: 'kat', baslik: t('kat'), ham: (b) => b.kat, hizalama: 'sag' },
    {
    ...
    { anahtar: 'brutM2', baslik: t('brutM2'), ham: (b) => b.brutM2, hizalama: 'sag' },
    { anahtar: 'netM2', baslik: t('netM2'), ham: (b) => b.netM2, hizalama: 'sag', varsayilanGizli: true },
    { anahtar: 'arsaPayi', baslik: t('arsaPayi'), ham: (b) => b.arsaPayi, hizalama: 'sag' },
    {
